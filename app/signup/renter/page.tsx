...
export default function RenterSignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call signup API with RENTER account type
      ...
      if (signInResult?.error) {
        ...
        // Success - redirect to renter dashboard
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-lg">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Find and save your perfect sublet
              </p>
            </div>
          ...
          <p className="text-center mt-6 text-sm text-gray-600">
            ...
            <Link href="/signup/landlord" className="font-medium text-teal-600 hover:text-teal-700 transition-colors">
