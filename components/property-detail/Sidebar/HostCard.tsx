...
export default function HostCard({ landlord, propertyCreatedAt }: HostCardProps) {
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            {landlord.verified && (
              <VerifiedBadge type="host" showTooltip={true} size="md" />
            )}
          </div>

          <p className="text-sm text-gray-600 mb-3">Property Host</p>
